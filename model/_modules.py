...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask):
        ...
        # 确保attention_mask的维度与attention_scores匹配
        if attention_scores.size() != attention_mask.size():
            # 如果维度不匹配，调整attention_mask的形状
            # 通常attention_mask的形状是[batch_size, 1, seq_len, seq_len]，
            # 而attention_scores的形状是[batch_size, num_heads, seq_len, seq_len]
            # 需要将attention_mask扩展到与attention_scores相同的形状
